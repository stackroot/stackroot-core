  ...
  return (
    <section id="about" className="max-w-7xl mx-auto px-4 md:px-8 py-16 scroll-mt-18">
      ...
      <p className="text-neutral-700 max-w-3xl leading-relaxed mb-8">
        ...
        scalable, responsive UIs — both in traditional Web2 environments and on the
        cutting edge of Web3. I believe in building quietly, intentionally, and
        efficiently.
      </p>
      <p className="text-gray-600 text-md leading-relaxed mb-8">
        ...
        I'm currently available for freelance work on a project basis.
      </p>
